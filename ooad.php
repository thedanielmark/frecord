    ...
    <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="1" value="" id="defaultCheck1" disabled>
        ...
        <li class="list-group-item">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="ex2" value="" name="ex2" id="defaultCheck2">
        ...
        <li class="list-group-item">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="3" value="" id="defaultCheck3" disabled>
        ...
        <li class="list-group-item">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="4" value="" id="defaultCheck4" disabled>
        ...
        <li class="list-group-item">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="5" value="" id="defaultCheck5" disabled>
        ...
        <li class="list-group-item">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="6" value="" id="defaultCheck6" disabled>
        ...
        <li class="list-group-item">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="7" value="" id="defaultCheck7" disabled>
        ...
        <li class="list-group-item">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="8" value="" id="defaultCheck8" disabled>
        ...
        <li class="list-group-item">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="9" value="" id="defaultCheck9" disabled>
        ...
        <li class="list-group-item">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="10" value="" id="defaultCheck10" disabled>
